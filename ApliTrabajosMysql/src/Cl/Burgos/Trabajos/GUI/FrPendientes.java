 ...
 * @author march
 */
public class FrPendientes extends javax.swing.JFrame {

    DAOTrabajos dAOTrabajos = new DAOTrabajos();
    long lngNumPaginas;
    /**
     * Creates new form FrPendientes
     */
    public FrPendientes() {
        initComponents();
    ...
    public void defineTablaPendientes(String strBusqueda,long DesdeHoja){
        ...
        String strTitulos[]={"NOMBRE CLIENTE","ID TRABAJO","NOMBRE TRABAJO","ABONO","PAGO","TOTAL"};
...
//        DAOPc classCliente= new DAOPc();
        ...
        dAOTrabajos.listarTrabjosP(lngDesdeRegistro, (Long.valueOf(1000)),tablaClientes,strBusqueda);
        
        //LE PONEMOS EL RESULTADO DE LA CONSULA AL JTABLE
        this.jTabTrabajos.setModel(tablaClientes);
        
        //ASIGNAMOS LOS VALORES A LA PAGINACION
//        lngRegistros = dAOTrabajos.cuantosTrabajos(0);
...
//        this.jlblTotalPaginas.setText(" De " + ( lngNumPaginas));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrPendientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrPendientes().setVisible(true);
            }
        });
    }
